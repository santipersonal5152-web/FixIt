    ...
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      >
        ...
        <SolucionesRapi
          ...
          consejos={[
            "Si no centrifuga o no desagua, revisa que la manguera de desagüe no esté doblada, obstruida o muy alta.",
            "La lavadora debe estar nivelada. ajusta las patas hasta que quede estable.",
            "Si hace ruido extraño, puede haber un objeto (como una moneda o un sujetador) atrapado en el tambor.",
            "Antes de abrir, espera a que se enfríe la tapa (en lavadoras de carga frontal) por seguridad.",
            "Comprueba que la tapa o puerta cierre correctamente. Muchos modelos no inician el ciclo si no detectan el cierre.",
          ]}
          maxWidthTexto={290}
        />
