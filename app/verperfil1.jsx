  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTexto
        ...
        valorInicial="anagarcia20@gmail.com"
        mostrarBotonEditar={false}
      />
      
      <CampoTextoGrande
              label="Descripción y experiencia"
              valorInicial="Técnico con experiencia en instalación, mantenimiento y reparación de sistemas. Responsable, puntual y enfocado en brindar soluciones seguras, eficientes y de calidad para garantizar el óptimo funcionamiento de los equipos."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Lunes a viernes: 8 am - 5 pm"
        mostrarBotonEditar={false}
      />
