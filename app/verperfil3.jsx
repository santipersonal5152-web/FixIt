  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTexto
        ...
        valorInicial="julioleon232@gmail.com"
        mostrarBotonEditar={false}
      />
      
      <CampoTextoGrande
              label="Descripción y experiencia"
              valorInicial="Técnico de campo con amplia experiencia en diagnóstico y resolución de fallas técnicas. Soy una persona responsable, puntual y con excelente trato al cliente, enfocado en ofrecer soluciones prácticas, seguras y duraderas."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Lunes a viernes: 7 pm - 5 am"
        mostrarBotonEditar={false}
      />
