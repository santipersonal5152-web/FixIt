...
export default function prueba() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTexto
        label="Nombre"
        valorInicial="Ana García"
        mostrarBotonEditar={false}
      />
      <CampoTexto
        label="Correo Electrónico"
        valorInicial="anagarci654@gamil.com"
        mostrarBotonEditar={false}
      />
      
      <CampoTextoGrande
              label="Descripción y experiencia"
              valorInicial="Plomero con amplia experiencia en instalación, mantenimiento y reparación de sistemas hidráulicos y sanitarios. Responsable, puntual y con un enfoque dedicado a brindar soluciones duraderas, seguras y de la más alta calidad para hogares y negocios."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Miercoles a Domingo: 5 am - 2 pm"
        mostrarBotonEditar={false}
      />
