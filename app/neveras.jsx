    ...
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      >
        ...
        <SolucionesRapi
          ...
          consejos={[
            "Verifica que la nevera esté nivelada. Si no lo está, el compresor puede trabajar forzado.",
            "Limpia las bobinas del condensador (generalmente en la parte posterior o inferior) con un cepillo; el polvo reduce la eficiencia.",
            "Asegúrate de que el sello de la goma de la puerta esté limpio y cierre bien. Si no sella, entrará aire caliente.",
            "Escucha si el compresor enciende. Si no hace ningún sonido, revisa el enchufe y el breaker.",
            "No coloques alimentos calientes dentro, esto fuerza el motor y aumenta el consumo.",
          ]}
          maxWidthTexto={290}
        />
