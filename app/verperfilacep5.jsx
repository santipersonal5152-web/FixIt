...
export default function prueba() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTexto
        label="Nombre"
        valorInicial="Julio Leon"
        mostrarBotonEditar={false}
      />
      <CampoTexto
        label="Correo Electrónico"
        valorInicial="juliotrabajo@gmail.com"
        mostrarBotonEditar={false}
      />
      
      <CampoTextoGrande
              label="Descripción y experiencia"
              valorInicial="Plomero con expertise en la instalación y diseño de sistemas de fontanería para obras nuevas y remodelaciones. Técnico meticuloso que garantiza instalaciones eficientes, cumpliendo con los códigos de construcción y enfocado en la calidad y funcionalidad a largo plazo."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Lunes a viernes: 10 am - 2 pm"
        mostrarBotonEditar={false}
      />
