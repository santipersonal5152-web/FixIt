  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTextoGrande
              ...
              valorInicial="Técnico especializado en la instalación y reparación de sistemas de climatización y refrigeración. Profesional responsable y puntual, comprometido con la seguridad y la calidad en cada servicio para asegurar el máximo rendimiento de los equipos."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Lunes a viernes: 2 pm - 11 pm"
        mostrarBotonEditar={false}
      />
