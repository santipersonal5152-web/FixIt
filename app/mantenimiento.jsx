    ...
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      >
        ...
        <SolucionesRapi
          ...
          consejos={[
            "Limpia regularmente filtros, rejillas de ventilación y juntas.",
            "No sobrecargues los electrodomésticos más allá de su capacidad recomendada.",
            "Inspecciona visualmente cables y mangueras en busca de desgaste o grietas.",
            "Lubrica partes móviles solo si el manual del fabricante lo recomienda.",
            "Programa una revisión profesional al menos una vez al año para equipos críticos como la nevera o la caldera.",
          ]}
          maxWidthTexto={290}
        />
