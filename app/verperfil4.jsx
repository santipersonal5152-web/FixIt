  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      <CampoTexto
        ...
        valorInicial="lucitorres213@gmail.com"
        mostrarBotonEditar={false}
      />
      
      <CampoTextoGrande
              label="Descripción y experiencia"
              valorInicial="Técnico industrial experto en el mantenimiento y la reparación de maquinaria y sistemas complejos. Profesional meticuloso, responsable y puntual, cuya prioridad es ejecutar intervenciones técnicas seguras y de alta calidad para minimizar tiempos de inactividad."
              mostrarBotonEditar={false}
              formato="bloque"
      />
      ...
      <CampoTexto
        ...
        valorInicial="Lunes a viernes: 4 pm - 1 am"
        mostrarBotonEditar={false}
      />
