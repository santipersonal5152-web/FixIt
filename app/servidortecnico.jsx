...
import Descripcion from "../assets/componentes/Descripcion"
...
experiencia"
      ...
      >
        ...
        <Text style={{ fontSize: 21, marginBottom: 20, color: "#FFF",paddingHorizontal: 70,textAlign: "center", }}>
          Cuéntanos sobre tu experiencia laboral y tus habilidades y fortalezas en tu campo, de esta forma, podremos recomendar tus servicios de forma más óptima
        </Text>

        <Descripcion 
          label="Describe tus habilidades y experiencia"
        />

        <Boton 
          texto="siguiente"
          destino="beneficiosescojetecnico"
        />
