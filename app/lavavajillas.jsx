  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#8CB3DB" }}>
      ...
      >
        ...
        <SolucionesRapi
          titulo="Reparación de Lavavajillas"
          consejos={[
            "Desconéctalo de la toma de corriente antes de hacer cualquier revisión.",
            "Revisa que el filtro inferior no esté obstruido por restos de comida; límpialo si es necesario.",
            "Verifica que la puerta cierre herméticamente. Un cierre defectuoso puede evitar que encienda.",
            "Asegúrate de que los brazos rociadores giren libremente y no estén bloqueados.",
            "Comprueba que el detergente se esté dispensando correctamente y no esté endurecido.",
          ]}
          maxWidthTexto={290}
        />
